...
from utilsmcn import AverageMeter, BestSaver, config_logging, prepare_dataloaders
...
#         return self.fc(x)
#
# # إنشاء نموذج وبيانات تجريبية
# model = SimpleModel()
# dummy_input = torch.randn(5, 10)
#
# # محاولة لحفظ واستعادة حالة النموذج
# try:
#     # حفظ حالة النموذج
#     torch.save(model.state_dict(), 'model_checkpoint.pth')
#
#     # تغيير في حالة النموذج (تخيل أن هناك تدريب مستمر)
#     model.fc.bias.data += 1.0
#
#     # استرجاع حالة النموذج من حالة النموذج المحفوظة
