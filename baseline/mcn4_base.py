...
if __name__ == "__main__":
    ...
    model = CompatModel(embed_size=1000, need_rep=True, vocabulary=len(train_dataset.vocabulary)
                        , vse_off=True, pe_off=True, mlp_layers=2, conv_feats="1234"  # added-$
                        ).to(device)
    model.load_state_dict(torch.load('./model_mcn.pth'))
    model.eval()

    print("=" * 80)
    # Comment different line to choose different outfit as example.
    # ID = ['209337385_1', '216705948_3', '208935911_4', '104608755_5', '203846891_4']
